...
- Name: e2e/color-history-panel.spec.ts >> Color History Panel >> color history remains after tool switching
- Location: tests/e2e/color-history-panel.spec.ts:440:7
