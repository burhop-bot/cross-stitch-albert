...
- Name: e2e/color-history-panel.spec.ts >> Color History Panel >> clicking a color in history sets it as active
- Location: tests/e2e/color-history-panel.spec.ts:207:7
