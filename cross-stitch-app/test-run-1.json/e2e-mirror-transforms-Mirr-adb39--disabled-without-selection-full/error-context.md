...
- Name: e2e/mirror-transforms.spec.ts >> Mirror Button States >> selection mirror buttons are disabled without selection
- Location: tests/e2e/mirror-transforms.spec.ts:638:7
