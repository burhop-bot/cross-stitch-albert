...
- Name: e2e/mirror-transforms.spec.ts >> Full-Grid Mirror — Vertical >> vertical mirror of single-column pattern reverses column order
- Location: tests/e2e/mirror-transforms.spec.ts:314:7
