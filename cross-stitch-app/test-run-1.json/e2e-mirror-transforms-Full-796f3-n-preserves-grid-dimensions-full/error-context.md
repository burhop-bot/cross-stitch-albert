...
- Name: e2e/mirror-transforms.spec.ts >> Full-Grid Mirror — Horizontal >> horizontal mirror of asymmetric pattern preserves grid dimensions
- Location: tests/e2e/mirror-transforms.spec.ts:247:7
