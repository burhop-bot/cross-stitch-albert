...
- Name: e2e/mirror-transforms.spec.ts >> PatternRepeatPanel Mirror >> Horizontal mirror mode tiles pattern with horizontal flip
- Location: tests/e2e/mirror-transforms.spec.ts:350:7
