...
- Name: e2e/mirror-transforms.spec.ts >> Full-Grid Mirror — Horizontal >> horizontal mirror reverses each row (data-level)
- Location: tests/e2e/mirror-transforms.spec.ts:173:7
