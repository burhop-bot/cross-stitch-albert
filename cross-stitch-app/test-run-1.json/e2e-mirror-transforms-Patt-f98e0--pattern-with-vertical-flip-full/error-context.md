...
- Name: e2e/mirror-transforms.spec.ts >> PatternRepeatPanel Mirror >> Vertical mirror mode tiles pattern with vertical flip
- Location: tests/e2e/mirror-transforms.spec.ts:406:7
