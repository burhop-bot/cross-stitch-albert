...
- Name: e2e/mirror-transforms.spec.ts >> Full-Grid Mirror — Horizontal >> horizontal mirror of a single-color row is stable
- Location: tests/e2e/mirror-transforms.spec.ts:220:7
